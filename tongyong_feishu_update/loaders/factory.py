...
from .converted_json import ConvertedJsonProductLoader
...
class LoaderFactory:
    ...
    _loaders: List[Type[BaseProductLoader]] = [
        ConvertedJsonProductLoader, # 优先检测转换JSON格式（你的格式）
        DetailedProductLoader,        # 其次检测详细格式
        SummarizedProductLoader,      # 然后是汇总格式
