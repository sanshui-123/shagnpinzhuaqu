...
const BRAND_CONFIG = {
    pg: {
        name: 'PEARLY GATES',
        baseUrl: 'https://www.pearlygates.net',
        colorSelector: '.color-selector li, .product-color-item',
        sizeListSelector: '.size-selector, .product-size-list'
    }
};

class InventoryChecker {
    constructor(options = {}) {
        this.brand = options.brand || 'pg';
